...
export type DeveloperServiceGuidance = {
  ...
  flowRelation: "sequence" | "flexible" | "parallel" | "conditional" | "closure";
  applicationUrl?: string;
  applicationLabel?: LocalizedText;
  evidenceUrl: string;
};

export const PRE_DEVELOPMENT_ROUTE_ORDER = [
...
export const POST_DEVELOPMENT_ROUTE_ORDER = [
...
export const DEVELOPER_SERVICE_GUIDANCE: Record<string, DeveloperServiceGuidance> = {
  ...
  "submission-of-the-initial-approval-certificate": {
    provider: { en: "Dubai Department of Economy and Tourism (DET; DED in the DLD record)", ar: "دائرة الاقتصاد والسياحة بدبي (DET؛ تظهر DED في سجل الدائرة)" },
    prerequisite: { en: "Create the business-licensing file with the selected activity, legal form and owners. Dubai’s official guidance allows the trade name to be reserved either before or after this initial approval.", ar: "أنشئ ملف ترخيص الأعمال بالنشاط والشكل القانوني والملاك. تتيح إرشادات دبي الرسمية حجز الاسم التجاري قبل هذه الموافقة المبدئية أو بعدها." },
