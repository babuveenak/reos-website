...
const gatewayContent = [
  ...
  { id:"G3", slug:"authorities-approvals", name:"Authorities & Approvals", question:"Have all applicable authorities granted permission to build?", purpose:"Coordinate Municipality, DDA, RERA, DLD, Civil Defense and utility requirements into a verified approval route.", activities:["Municipality","DDA","RERA","DLD","Civil Defense","Utility approvals"], primaryOutput:"Permission to build", landmark:"Civic checkpoint and permit lanes", accent:"#62C8B5",
  ...
  { id:"G7", slug:"asset-growth-intelligence", name:"Asset Growth & Intelligence", question:"How will the operating asset create and protect long-term value?", purpose:"Use portfolio management, leasing, resale, analytics and AI-supported insight to improve asset and investment performance.", activities:["Portfolio management","Investment performance","Resale","Leasing","Analytics","AI insights"], primaryOutput:"Long-term value creation", landmark:"Operating portfolio, analytics and growth curve", accent:"#70D39B",
