...
export function PreferencesControls(){
 ...
 useEffect(()=>{const root=document.documentElement;
  const t=(localStorage.getItem("reos-theme") as Theme)||(root.dataset.theme as Theme)||"light",s=(localStorage.getItem("reos-scale") as Scale)||(root.dataset.fontScale as Scale)||"normal",l=(localStorage.getItem("reos-language") as Language)||(root.lang as Language)||"en";
